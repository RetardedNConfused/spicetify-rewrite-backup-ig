...
((search ||= {}).on ||= {}).youtube = (() => {
  ...
  var require_internal = __commonJS({
    ".yarn/cache/fp-ts-npm-2.16.1-8deb3ec2d6-94e8bb1d03.zip/node_modules/fp-ts/lib/internal.js"(exports) {
      ...
      var fromReadonlyNonEmptyArray3 = function(as) {
        return __spreadArray4([as[0]], as.slice(1), true);
      };
    ...
    ".yarn/cache/fp-ts-npm-2.16.1-8deb3ec2d6-94e8bb1d03.zip/node_modules/fp-ts/lib/ReadonlyNonEmptyArray.js"(exports) {
      ...
      var prependW2 = function(head4) {
        return function(tail3) {
          return __spreadArray4([head4], tail3, true);
        };
      };
      ...
      var unsafeInsertAt2 = function(i, a, as) {
      ...
      var unsafeUpdateAt2 = function(i, a, as) {
        if (as[i] === a) {
          return as;
        } else {
          var xs = _.fromReadonlyNonEmptyArray(as);
      ...
      var reverse3 = function(as) {
        return as.length === 1 ? as : __spreadArray4([(0, exports.last)(as)], as.slice(0, -1).reverse(), true);
      };
      exports.reverse = reverse3;
      function group(E) {
        return function(as) {
      ...
      var modifyHead = function(f) {
        return function(as) {
          return __spreadArray4([f((0, exports.head)(as))], (0, exports.tail)(as), true);
        };
      };
      ...
      function cons2(head4, tail3) {
        return tail3 === void 0 ? (0, exports.prepend)(head4) : (0, function_1.pipe)(tail3, (0, exports.prepend)(head4));
      }
      exports.cons = cons2;
  ...
  var require_ReadonlyRecord = __commonJS({
    ".yarn/cache/fp-ts-npm-2.16.1-8deb3ec2d6-94e8bb1d03.zip/node_modules/fp-ts/lib/ReadonlyRecord.js"(exports) {
      ...
      exports.map = map3;
      function reduceWithIndex2() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          args[_i] = arguments[_i];
        }
        if (args.length === 2) {
          return reduceWithIndex2(S.Ord).apply(void 0, args);
        }
      ...
      function foldMapWithIndex2(O) {
        ...
        return foldMapWithIndex2(S.Ord)(O);
      }
      exports.foldMapWithIndex = foldMapWithIndex2;
      function reduceRightWithIndex2() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          args[_i] = arguments[_i];
        }
        if (args.length === 2) {
          return reduceRightWithIndex2(S.Ord).apply(void 0, args);
        }
        var keysO = keys_(args[0]);
        return function(b, f) {
          return function(fa) {
      ...
      var _map = function(fa, f) {
        return (0, function_1.pipe)(fa, map3(f));
      };
      exports._map = _map;
      var _mapWithIndex = function(fa, f) {
      ...
      var _reduceRight = function(O) {
        var reduceRightO = reduceRight2(O);
        return function(fa, b, f) {
      ...
      var _reduceWithIndex = function(O) {
        var reduceWithIndexO = reduceWithIndex2(O);
        return function(fa, b, f) {
      ...
      var _foldMapWithIndex = function(O) {
        var foldMapWithIndexO = foldMapWithIndex2(O);
        return function(M) {
      ...
      var _reduceRightWithIndex = function(O) {
        var reduceRightWithIndexO = reduceRightWithIndex2(O);
        return function(fa, b, f) {
      ...
      function reduce2() {
        ...
        if (args.length === 1) {
          var reduceWithIndexO_1 = reduceWithIndex2(args[0]);
          return function(b, f) {
        ...
        return reduce2(S.Ord).apply(void 0, args);
      }
      exports.reduce = reduce2;
      function foldMap2(O) {
        if ("compare" in O) {
          var foldMapWithIndexO_1 = foldMapWithIndex2(O);
          return function(M) {
      ...
      function reduceRight2() {
        ...
        if (args.length === 1) {
          var reduceRightWithIndexO_1 = reduceRightWithIndex2(args[0]);
          return function(b, f) {
        ...
        return reduceRight2(S.Ord).apply(void 0, args);
      }
      exports.reduceRight = reduceRight2;
  ...
  var __spreadArray2, head, fromReadonlyNonEmptyArray;
  ...
  var constant, concatAll2, semigroupVoid, semigroupAll, semigroupAny, semigroupString, semigroupSum, semigroupProduct;
  ...
  var init_NonEmptyArray = __esm({
    ".yarn/cache/fp-ts-npm-2.16.1-8deb3ec2d6-94e8bb1d03.zip/node_modules/fp-ts/es6/NonEmptyArray.js"() {
      ...
      splitAt = function(n) {
        return function(as) {
          var m = Math.max(1, n);
          return m >= as.length ? [copy(as), []] : [pipe(as.slice(1, m), prepend(head3(as))), as.slice(m)];
        };
      };
      chunksOf = function(n) {
  ...
  var import_function4, import_Predicate, import_Functor, import_Apply, import_Chain, URI, map2, Functor, of2, ap, Applicative, apFirst, apSecond, chain, Monad, Do, bindTo, bind, apS, let_, unary, unless, when, invoke, invokeNullary, curry2T, curry2, curry3T, curry3, curry4T, curry4, curry5T, curry5, applyEvery;
  var init_Function = __esm({
    ".yarn/__virtual__/fp-ts-std-virtual-f10c7c3878/0/cache/fp-ts-std-npm-0.17.1-8c0fa4fe44-c9e2cba727.zip/node_modules/fp-ts-std/dist/esm/Function.js"() {
      import_function4 = __toESM(require_function());
      import_Predicate = __toESM(require_Predicate());
      init_Endomorphism();
      init_Monoid();
      import_Functor = __toESM(require_Functor());
      import_Apply = __toESM(require_Apply());
      import_Chain = __toESM(require_Chain());
      URI = "Function";
      map2 = (f) => (g) => (0, import_function4.flow)(g, f);
      Functor = {
        URI,
        map: (f, g) => map2(g)(f)
      };
      of2 = import_function4.constant;
      ap = (f) => (g) => (x) => g(x)(f(x));
      Applicative = {
        ...Functor,
        of: of2,
      ...
      apFirst = (0, import_Apply.apFirst)(Applicative);
      apSecond = (0, import_Apply.apSecond)(Applicative);
      chain = (f) => (g) => (x) => f(g(x))(x);
      Monad = {
        ...Applicative,
        chain: (f, g) => chain(g)(f)
      ...
      Do = of2({});
      bindTo = (0, import_Functor.bindTo)(Functor);
      bind = (0, import_Chain.bind)(Monad);
      apS = (0, import_Apply.apS)(Applicative);
      let_ = (0, import_Functor.let)(Functor);
      unary = import_function4.tupled;
      unless = (f) => (onFalse) => (x) => f(x) ? x : onFalse(x);
      when = (0, import_function4.flow)(import_Predicate.not, unless);
      invoke = (x) => (ys) => (z) => z[x](...ys);
      invokeNullary = (0, import_function4.flip)(invoke)([]);
      curry2T = (f) => (a) => (b) => f([a, b]);
      curry2 = (0, import_function4.flow)(unary, curry2T);
      curry3T = (f) => (a) => (b) => (c) => f([a, b, c]);
      curry3 = (0, import_function4.flow)(unary, curry3T);
      curry4T = (f) => (a) => (b) => (c) => (d) => f([a, b, c, d]);
      curry4 = (0, import_function4.flow)(unary, curry4T);
      curry5T = (f) => (a) => (b) => (c) => (d) => (e) => f([a, b, c, d, e]);
      curry5 = (0, import_function4.flow)(unary, curry5T);
      applyEvery = concatAll4(getMonoid());
    }
  });
    ...
    "src/settings.tsx"() {
      ...
      CONFIG = new Proxy(settings, {
        get: function get(target, prop) {
          return target.getFieldValue(prop.toString());
        }
      });
    }
  });
  ...
  var import_function5, fetchTracksSpotAPI50, fetchTracksSpotAPI, searchYoutube;
  var init_api = __esm({
    "src/api.tsx"() {
      "use strict";
      init_Array();
      init_settings();
      import_function5 = __toESM(require_function(), 1);
      init_Array();
      fetchTracksSpotAPI50 = /* @__PURE__ */ function() {
        var _ref = _asyncToGenerator2(/* @__PURE__ */ _regeneratorRuntime2().mark(function _callee2(ids) {
          return _regeneratorRuntime2().wrap(function _callee$(_context) {
            while (1)
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  return _context.abrupt("return", _context.sent.tracks);
                case 3:
                case "end":
                  return _context.stop();
              }
        ...
        return function fetchTracksSpotAPI502(_x) {
          return _ref.apply(this, arguments);
        };
      }();
      fetchTracksSpotAPI = (0, import_function5.flow)(chunksOf2(50), map(fetchTracksSpotAPI50), /* @__PURE__ */ function() {
        var _ref2 = _asyncToGenerator2(/* @__PURE__ */ _regeneratorRuntime2().mark(function _callee2(x) {
          return _regeneratorRuntime2().wrap(function _callee2$(_context2) {
            while (1)
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.t0 = flatten;
                  _context2.next = 3;
      ...
      searchYoutube = /* @__PURE__ */ function() {
        var _ref3 = _asyncToGenerator2(/* @__PURE__ */ _regeneratorRuntime2().mark(function _callee3(searchString) {
          return _regeneratorRuntime2().wrap(function _callee3$(_context3) {
            while (1)
              switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return fetch("https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q=".concat(encodeURIComponent(searchString), "&type=video&key=").concat(CONFIG.YouTubeApiKey));
                case 2:
                  _context3.next = 4;
        ...
        return function searchYoutube2(_x3) {
  ...
  // src/util.tsx
  var SpotifyURIType, normalizeStr;
  var init_util = __esm({
    "src/util.tsx"() {
      "use strict";
      ...
      normalizeStr = function normalizeStr2(str) {
        return str.replace(/\(.*\)/g, "").replace(/\[.*\]/g, "").replace(/[^a-zA-Z0-9]/g, "").toLowerCase();
      };
    }
  });
  ...
  var init_app = __esm({
    "src/app.tsx"() {
      ...
      showOnYouTube = /* @__PURE__ */ function() {
        var _ref = _asyncToGenerator3(/* @__PURE__ */ _regeneratorRuntime3().mark(function _callee2(uri) {
          var _videos, _videos$find$id$video, _videos$find, track, searchString, videos, normalizedTrackName;
            ...
            while (1)
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.t0 = parseTrackFromSpotifyAPI;
                  _context.next = 4;
                  return fetchTracksSpotAPI([uri]);
                case 4:
                  _context.t1 = _context.sent;
                  track = (0, _context.t0)(_context.t1);
                  searchString = "".concat(track.artistName, " - ").concat(track.name, " video song");
                  videos = [];
                  ...
                  _context.prev = 9;
                  _context.next = 12;
                  return searchYoutube(searchString);
                case 12:
                ...
                case 17:
                  if ((_videos = videos) !== null && _videos !== void 0 && _videos.length) {
                    _context.next = 19;
                    break;
                  }
                  return _context.abrupt("return", void window.open("https://www.youtube.com/results?search_query=".concat(encodeURIComponent(searchString))));
                case 19:
                  normalizedTrackName = normalizeStr(track.name);
                  YTVidIDCache.set(uri, (_videos$find$id$video = (_videos$find = videos.find(function(video) {
                    normalizeStr(video.snippet.title).includes(normalizedTrackName);
                  })) === null || _videos$find === void 0 ? void 0 : _videos$find.id.videoId) !== null && _videos$find$id$video !== void 0 ? _videos$find$id$video : videos[0].id.videoId);
                case 21:
                  window.open("https://www.youtube.com/watch?v=".concat(YTVidIDCache.get(uri)));
                case 22:
                case "end":
                  return _context.stop();
              }
        ...
        return function showOnYouTube2(_x) {
          return _ref.apply(this, arguments);
        };
      }();
      showIn = function showIn2(allowedTypes) {
        return function(_ref2) {
          var _ref3 = _slicedToArray2(_ref2, 1), uri = _ref3[0];
          return allowedTypes.some(String.prototype.startsWith.bind(uri));
        };
      };
      new Spicetify.ContextMenu.Item("Play on YouTube", unary(showOnYouTube), showIn([SpotifyURIType.TRACK]), '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="19px" height="19px"><path fill="currentColor" d="M43.2,33.9c-0.4,2.1-2.1,3.7-4.2,4c-3.3,0.5-8.8,1.1-15,1.1c-6.1,0-11.6-0.6-15-1.1c-2.1-0.3-3.8-1.9-4.2-4C4.4,31.6,4,28.2,4,24c0-4.2,0.4-7.6,0.8-9.9c0.4-2.1,2.1-3.7,4.2-4C12.3,9.6,17.8,9,24,9c6.2,0,11.6,0.6,15,1.1c2.1,0.3,3.8,1.9,4.2,4c0.4,2.3,0.9,5.7,0.9,9.9C44,28.2,43.6,31.6,43.2,33.9z"/><path fill="var(--spice-main)" d="M20 31L20 17 32 24z"/></svg>').register();
    }
  });
    ...
    return _regeneratorRuntime4().wrap(function _callee$(_context) {
      while (1)
        switch (_context.prev = _context.next) {
          ...
          case 2:
            if (!mustLoad.map((0, import_function6.flow)(function(p) {
